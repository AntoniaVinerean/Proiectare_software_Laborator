...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Lista dupa aplicarea notei minime de 4:");
        ...
        System.out.println("Rulare Export Strategy");

        context = new StudentiInConsola();
        context.exporta(studentiCuNote);

        context = new StudentiInFisierText();
        context.exporta(studentiCuNote);

        context = new StudentiInFisierXlsx();
        context.exporta(studentiCuNote);
        System.out.println(" ");
